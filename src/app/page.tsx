...
export default function HomePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <Header title="Home" />
        <main className="container mx-auto max-w-2xl px-4 py-4 pb-32 sm:py-6 sm:pb-32 mt-[72px]">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Content */}
      <main className="container mx-auto max-w-2xl px-4 py-4 pb-32 sm:py-6 sm:pb-32 mt-[72px] space-y-6">
        {/* Le Sessioni */}
