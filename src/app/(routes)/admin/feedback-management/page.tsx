...
import FeedbackManagementView from "@/components/feedback-management/FeedbackManagementView"
...
export default function FeedbackManagementPage() {
  ...
  const [sessionStatus, setSessionStatus] = useState<SessionStatus>('in-progress')
  const sessions = mockSessionsApi.getAll().filter(s => s.stato === 'In corso' || s.stato === 'Conclusa')
