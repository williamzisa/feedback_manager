...
- **UI & Logica**:
  ...
  - Utilizzare componenti Shadcn UI (es. `MultiSelect` o `Checkbox` list) per la selezione dei team.
- **Mutations & Caching**:
...
- **Performance**: Monitorare le performance delle query, specialmente quelle con join multipli, e ottimizzare se necessario (es. indici DB).
